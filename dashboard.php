	  ...
	  <div class="row">
		<div class="dashboard">
		 <div class="col-md-9 content">
		     <div class="notice notice-error is-dismissible below-h2" style="display:none" id="message"><p></p></div>
			 <div class='btn-group'>
		  ...
		  <?php 
		   ...
		   {
			   echo '<div class="updated notice notice-success is-dismissible below-h2"  id="message"><p>'.$res['msg'].'</p></div>';	   
		   } 
		   ?>
	<?php
	}
